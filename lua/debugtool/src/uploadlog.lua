...
function Uploader:send(data, fnCallback)
    local url = gDbgConfig.logserver .. "/log/uploadlog.php"
...
function Uploader:uploadFile(filePath, uploadEventHandler)
    ...
    self._uploadFileName = string.match(filePath, "([^/\\]+.txt)")
