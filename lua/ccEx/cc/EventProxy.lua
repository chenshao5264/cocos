...
function EventProxy:on(eventName, listener, data)
    return self:addEventListener(eventName, listener, data)
end

function EventProxy:once(eventName, listener)
    return self:addEventListener(eventName, listener, "once")
end
