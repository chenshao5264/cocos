...
//    
    ...
    NSString* strProductIdentifier = transaction.payment.productIdentifier;
    NSString* strIsRestored;
    if(isRestored) {
        strIsRestored = @"0";
    } else {
        strIsRestored = @"1";
    }
    NSString* strReceipt = [self getReceipt:transaction];
    NSString* strTransactionIdentifier = transaction.transactionIdentifier;
    
   
    NSDictionary* dic = [NSDictionary dictionaryWithObjectsAndKeys:
                         strProductIdentifier, @"strProductIdentifier",
                         strIsRestored, @"strIsRestored",
                         strReceipt, @"strReceipt",
                         strTransactionIdentifier, @"strTransactionIdentifier",
                         @"0", @"resultCode",
                         nil];
    ...
    [QSHelper callBackCocos2dFunction:payResultCallBack JsongString:jsonString];
}
