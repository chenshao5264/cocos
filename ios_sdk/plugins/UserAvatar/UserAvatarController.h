...
@interface UserAvatarController : NSObject<UIApplicationDelegate,UIImagePickerControllerDelegate, UIActionSheetDelegate,UINavigationControllerDelegate, NSFileManagerDelegate>
{
...
void SettingAvaterFormiOS(int, const char*);
